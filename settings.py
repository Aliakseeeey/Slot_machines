...
# Иконки
# symbols = {
#     'raccoon_x_1': f"{SYM_PATH}/Енот.png",
#     'bear_b_2': f"{SYM_PATH}/медведь.png",
#     'lion_c_3': f"{SYM_PATH}/лев.png",
#     'raccoon_x_4': f"{SYM_PATH}/Енот.png",
#     'raccoon_x_5': f"{SYM_PATH}/Енот.png",
